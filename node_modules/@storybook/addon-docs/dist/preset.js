import CJS_COMPAT_NODE_URL_q6wjee4evc from 'node:url';
import CJS_COMPAT_NODE_PATH_q6wjee4evc from 'node:path';
import CJS_COMPAT_NODE_MODULE_q6wjee4evc from "node:module";

var __filename = CJS_COMPAT_NODE_URL_q6wjee4evc.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_q6wjee4evc.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_q6wjee4evc.createRequire(import.meta.url);

// ------------------------------------------------------------
// end of CJS compatibility banner, injected by Storybook's esbuild configuration
// ------------------------------------------------------------
import "./_node-chunks/chunk-HRLOHX4R.js";
...
async function webpack(webpackConfig = {}, options) {
  let { module = {} } = webpackConfig, { csfPluginOptions = {}, mdxPluginOptions = {} } = options, enrichCsf = await options.presets.apply("experimental_enrichCsf"), rehypeSlug = (await import("./_node-chunks/rehype-slug-EBWWWHXI.js")).default, rehypeExternalLinks = (await import("./_node-chunks/rehype-external-links-4M3FZ7NI.js")).default, mdxLoaderOptions = await options.presets.apply("mdxLoaderOptions", {
    ...mdxPluginOptions,
    mdxCompileOptions: {
...
var docs = (input = {}, options) => {
  ...
  let { plugins = [] } = config, { mdxPlugin } = await import("./_node-chunks/mdx-plugin-25HFYNRA.js"), { react, reactDom, mdx } = await getResolvedReact(options), packageDeduplicationPlugin = {
