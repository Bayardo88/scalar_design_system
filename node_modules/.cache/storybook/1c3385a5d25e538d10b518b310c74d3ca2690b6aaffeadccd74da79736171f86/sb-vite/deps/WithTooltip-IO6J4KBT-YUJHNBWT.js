...
} from "./chunk-6Q6OJZS5.js";
import {
  require_react_dom
} from "./chunk-R5STSVTI.js";
import {
  require_global
...
// node_modules/storybook/dist/_browser-chunks/WithTooltip-IO6J4KBT.js
...
var useIsomorphicLayoutEffect = typeof window < "u" && window.document && window.document.createElement ? React2.useLayoutEffect : React2.useEffect;
var top = "top";
var bottom = "bottom";
var right = "right";
var left = "left";
...
function mapToStyles(_ref2) {
  ...
  var commonStyles = Object.assign({
    position
  }, adaptive && unsetSides), _ref4 = roundOffsets === true ? roundOffsetsByDPR({
    x,
    y
  }, getWindow(popper2)) : {
    x,
...
function computeStyles(_ref5) {
  var state = _ref5.state, options = _ref5.options, _options$gpuAccelerat = options.gpuAcceleration, gpuAcceleration = _options$gpuAccelerat === void 0 ? true : _options$gpuAccelerat, _options$adaptive = options.adaptive, adaptive = _options$adaptive === void 0 ? true : _options$adaptive, _options$roundOffsets = options.roundOffsets, roundOffsets = _options$roundOffsets === void 0 ? true : _options$roundOffsets, commonStyles = {
...
function getCompositeRect(elementOrVirtualElement, offsetParent, isFixed) {
  ...
  isScrollParent(documentElement)) && (scroll = getNodeScroll(offsetParent)), isHTMLElement(offsetParent) ? (offsets = getBoundingClientRect(offsetParent, true), offsets.x += offsetParent.clientLeft, offsets.y += offsetParent.clientTop) : documentElement && (offsets.x = getWindowScrollBarX(documentElement))), {
...
function popperGenerator(generatorOptions) {
  ...
  return function(reference2, popper2, options) {
    ...
    var state = {
      ...
      attributes: {},
      styles: {}
    }, effectCleanupFns = [], isDestroyed = false, instance = {
      state,
      ...
      forceUpdate: function() {
        if (!isDestroyed) {
          ...
          if (areValidElements(reference3, popper3)) {
            ...
            }, state.reset = false, state.placement = state.options.placement, state.orderedModifiers.forEach(function(modifier) {
...
var EMPTY_MODIFIERS = [];
var usePopper = function(referenceElement, popperElement, options) {
  options === void 0 && (options = {});
...
var Tooltip = import_react.default.forwardRef(
  ({
    ...
    withArrows,
    ...props
  }, ref) => import_react.default.createElement(Wrapper, { "data-testid": "tooltip", hasChrome, ref, ...props, color }, hasChrome && withArrows && import_react.default.createElement(Arrow, { placement, ...arrowProps, color }), children)
);
...
var WithTooltipPure = ({
  ...
  ), portalTarget = (typeof portalContainer == "string" ? document2.querySelector(portalContainer) : portalContainer) || document2.body, tooltipComponent = isVisible ? import_react.default.createElement(
    Tooltip,
    {
      placement: state?.placement,
      ref: setTooltipRef,
...
var WithToolTipState = ({
  ...
  let [tooltipShown, setTooltipShown] = (0, import_react.useState)(startOpen), onVisibilityChange = (0, import_react.useCallback)(
    (visibility) => {
  ...
  return (0, import_react.useEffect)(() => {
    let hide2 = () => onVisibilityChange(false), handleKeyDown = (e) => {
      e.key === "Escape" && hide2();
    };
  ...
  }), import_react.default.createElement(WithTooltipPure, { ...rest, visible: tooltipShown, onVisibleChange: onVisibilityChange });
};
var DeprecatedPure = (props) => ((0, import_client_logger.deprecate)(
  "WithTooltipPure is deprecated and will be removed in Storybook 11. Please use WithTooltip instead."
), import_react.default.createElement(WithTooltipPure, { "data-deprecated": "WithTooltipPure", ...props }));
var DeprecatedState = (props) => ((0, import_client_logger.deprecate)(
  "WithToolTipState is deprecated and will be removed in Storybook 11. Please use WithTooltip instead."
), import_react.default.createElement(WithToolTipState, { "data-deprecated": "WithToolTipState", ...props }));
export {
  Tooltip,
...
//# sourceMappingURL=WithTooltip-IO6J4KBT-YUJHNBWT.js.map
