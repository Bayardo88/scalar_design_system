...
import "./chunk-XOGORFPY.js";
import "./chunk-QLUIIR5G.js";
import "./chunk-KH47UKKM.js";
import {
  logger,
  scope
} from "./chunk-6DO6LUFC.js";
import "./chunk-77HHKVKC.js";
import {
  require_react
...
// node_modules/@storybook/react/dist/_browser-chunks/chunk-DDIRQRCA.js
var import_react = __toESM(require_react(), 1);
var applyDecorators = (storyFn, decorators3) => defaultDecorateStory((context) => import_react.default.createElement(storyFn, context), decorators3);

// node_modules/@storybook/react/dist/_browser-chunks/chunk-SL3VIQZ3.js
...
// node_modules/@storybook/react/dist/_browser-chunks/chunk-34HS64JJ.js
...
var getAct = async ({ disableAct = false } = {}) => {
  ...
  if (typeof clonedReact.act == "function")
    ...
    let deprecatedTestUtils = await import("./react-dom_test-utils.js");
...
var render = (args, context) => {
  ...
  return import_react2.default.createElement(Component, { ...args });
};
...
var Wrapper = FRAMEWORK_OPTIONS?.strictMode ? import_react3.StrictMode : import_react3.Fragment;
var actQueue = [];
var isActing = false;
...
async function renderToCanvas({
  ...
  let { renderElement, unmountElement } = await import("./react-18-MEAN66AR.js"), Story = unboundStoryFn, content = storyContext.parameters.__isPortableStory ? import_react3.default.createElement(Story, { ...storyContext }) : import_react3.default.createElement(ErrorBoundary, { key: storyContext.id, showMain, showException }, import_react3.default.createElement(Story, { ...storyContext })), element = Wrapper ? import_react3.default.createElement(Wrapper, null, content) : content;
...
// node_modules/@storybook/react/dist/_browser-chunks/chunk-7SRU6CYS.js
...
var require_react_is_development = __commonJS({
  "../../node_modules/react-element-to-jsx-string/node_modules/react-is/cjs/react-is.development.js"(exports) {
    ...
    (function() {
      ...
      exports.ContextConsumer = ContextConsumer, exports.ContextProvider = ContextProvider, exports.Element = Element, exports.ForwardRef = ForwardRef2, exports.Fragment = Fragment22, exports.Lazy = Lazy, exports.Memo = Memo2, exports.Portal = Portal, exports.Profiler = Profiler, exports.StrictMode = StrictMode2, exports.Suspense = Suspense2, exports.SuspenseList = SuspenseList, exports.isAsyncMode = isAsyncMode, exports.isConcurrentMode = isConcurrentMode, exports.isContextConsumer = isContextConsumer2, exports.isContextProvider = isContextProvider2, exports.isElement = isElement, exports.isForwardRef = isForwardRef3, exports.isFragment = isFragment, exports.isLazy = isLazy2, exports.isMemo = isMemo3, exports.isPortal = isPortal, exports.isProfiler = isProfiler2, exports.isStrictMode = isStrictMode2, exports.isSuspense = isSuspense2, exports.isSuspenseList = isSuspenseList, exports.isValidElementType = isValidElementType, exports.typeOf = typeOf;
    })();
  }
});
...
var isForwardRef = (component) => component.$$typeof === /* @__PURE__ */ Symbol.for("react.forward_ref");
function isObject(o) {
...
var supportFragment = !!import_react4.Fragment;
...
var _parseReactElement = function(element, options) {
  ...
  var defaultProps = filterProps(element.type.defaultProps || {}, noChildren), childrens = import_react4.default.Children.toArray(element.props.children).filter(onlyMeaningfulChildren).map(function(child) {
    return _parseReactElement(child, options);
  });
  return supportFragment && element.type === import_react4.Fragment ? createReactFragmentTreeNode(key, childrens) : createReactElementTreeNode(displayName, props, defaultProps, childrens);
};
function noRefCheck() {
}
...
var formatComplexDataStructure = (function(value, inline, lvl, options) {
  var normalizedValue = sortObject(value), stringifiedValue = (0, import_pretty_print_object.prettyPrint)(normalizedValue, {
    transform: function(currentObj, prop, originalResult) {
      ...
      return currentValue && (0, import_react4.isValidElement)(currentValue) ? formatTreeNode(_parseReactElement(currentValue, options), true, lvl, options) : typeof currentValue == "function" ? formatFunction(currentValue, options) : originalResult;
    }
  });
...
var formatPropValue = function(propValue, inline, lvl, options) {
  ...
  return typeof propValue == "function" ? "{".concat(formatFunction(propValue, options), "}") : (0, import_react4.isValidElement)(propValue) ? "{".concat(formatTreeNode(_parseReactElement(propValue, options), true, lvl, options), "}") : propValue instanceof Date ? isNaN(propValue.valueOf()) ? "{new Date(NaN)}" : '{new Date("'.concat(propValue.toISOString(), '")}') : isPlainObject(propValue) || Array.isArray(propValue) ? "{".concat(formatComplexDataStructure(propValue, inline, lvl, options), "}") : "{".concat(String(propValue), "}");
};
...
// node_modules/@storybook/react/dist/_browser-chunks/chunk-FMVW4CIJ.js
  ...
  "../../node_modules/escodegen/node_modules/source-map/lib/source-node.js"(exports) {
    ...
    SourceNode.prototype.toStringWithSourceMap = function(aArgs) {
      var generated = {
        ...
        line: 1,
        column: 0
      }, map = new SourceMapGenerator(aArgs), sourceMappingActive = false, lastOriginalSource = null, lastOriginalLine = null, lastOriginalColumn = null, lastOriginalName = null;
      return this.walk(function(chunk, original) {
        generated.code += chunk, original.source !== null && original.line !== null && original.column !== null ? ((lastOriginalSource !== original.source || lastOriginalLine !== original.line || lastOriginalColumn !== original.column || lastOriginalName !== original.name) && map.addMapping({
          ...
          name: original.name
        }), lastOriginalSource = original.source, lastOriginalLine = original.line, lastOriginalColumn = original.column, lastOriginalName = original.name, sourceMappingActive = true) : sourceMappingActive && (map.addMapping({
          generated: {
            line: generated.line,
            column: generated.column
          }
        ...
        for (var idx = 0, length = chunk.length; idx < length; idx++)
          chunk.charCodeAt(idx) === NEWLINE_CODE ? (generated.line++, generated.column = 0, idx + 1 === length ? (lastOriginalSource = null, sourceMappingActive = false) : sourceMappingActive && map.addMapping({
            source: original.source,
            original: {
              line: original.line,
              column: original.column
      ...
      function generateRegExp(reg) {
        ...
        if (result = reg.toString(), reg.source) {
          if (match = result.match(/\/([^/]*)$/), !match)
            return result;
          for (flags = match[1], result = "", characterInBrack = false, previousIsBackslash = false, i = 0, iz = reg.source.length; i < iz; ++i)
            ch = reg.source.charCodeAt(i), previousIsBackslash ? (result += escapeRegExpCharacter(ch, previousIsBackslash), previousIsBackslash = false) : (characterInBrack ? ch === 93 && (characterInBrack = false) : ch === 47 ? result += "\\" : ch === 91 && (characterInBrack = true), result += escapeRegExpCharacter(ch, previousIsBackslash), previousIsBackslash = ch === 92);
          return "/" + result + "/" + flags;
        }
        return result;
      }
...
` && newlineCount++;
      ...
      CodeGenerator.prototype.generatePattern = function(node, precedence, flags) {
        ...
        if (hasDefault = false, node.type === Syntax.ArrowFunctionExpression && !node.rest && (!node.defaults || node.defaults.length === 0) && node.params.length === 1 && node.params[0].type === Syntax.Identifier)
          ...
          for (result = node.type === Syntax.ArrowFunctionExpression ? [generateAsyncPrefix(node, false)] : [], result.push("("), node.defaults && (hasDefault = true), i = 0, iz = node.params.length; i < iz; ++i)
...
` && (result = sourceMap ? toSourceNodeWhenNeeded(result).replaceRight(/\s+$/, "") : fragment.replace(/\s+$/, "")), toSourceNodeWhenNeeded(result, stmt);
      ...
      FORMAT_MINIFY = {
        ...
        parentheses: false,
        semicolons: false
      }, FORMAT_DEFAULTS = getDefaultOptions().format, exports.version = require_package().version, exports.generate = generate2, exports.attachComments = estraverse.attachComments, exports.Precedence = updateDeeply({}, Precedence), exports.browser = false, exports.FORMAT_MINIFY = FORMAT_MINIFY, exports.FORMAT_DEFAULTS = FORMAT_DEFAULTS;
    })();
  }
});
...
`, startPos - 1) + 1, this.curLine = this.input.slice(0, this.lineStart).split(lineBreak).length) : (this.pos = this.lineStart = 0, this.curLine = 1), this.type = types.eof, this.value = null, this.start = this.end = this.pos, this.startLoc = this.endLoc = this.curPosition(), this.lastTokEndLoc = this.lastTokStartLoc = null, this.lastTokStart = this.lastTokEnd = this.pos, this.context = this.initialContext(), this.exprAllowed = true, this.inModule = options.sourceType === "module", this.strict = this.inModule || this.strictDirective(this.pos), this.potentialArrowAt = -1, this.yieldPos = this.awaitPos = this.awaitIdentPos = 0, this.labels = [], this.undefinedExports = {}, this.pos === 0 && options.allowHashBang && this.input.slice(0, 2) === "#!" && this.skipLineComment(2), this.scopeStack = [], this.enterScope(SCOPE_TOP), this.regexpState = null;
      ...
      pp$1.parseFunction = function(node, statement, allowExpressionBody, isAsync) {
        ...
        var method = this.startNode(), tryContextual = function(k, noLineBreak) {
          ...
          return this$1.eatContextual(k) ? this$1.type !== types.parenL && (!noLineBreak || !this$1.canInsertSemicolon()) ? true : (method.key && this$1.unexpected(), method.computed = false, method.key = this$1.startNodeAt(start, startLoc), method.key.name = k, this$1.finishNode(method.key, "Identifier"), false) : false;
        };
...
`),
      ...
      pp$8.validateRegExpFlags = function(state) {
        ...
        state.pos = 0, state.lastIntValue = 0, state.lastStringValue = "", state.lastAssertionIsQuantifiable = false, state.numCapturingParens = 0, state.maxBackReference = 0, state.groupNames.length = 0, state.backReferenceNames.length = 0, this.regexp_disjunction(state), state.pos !== state.source.length && (state.eat(
          41
          /* ) */
        ...
        this.regexp_eatQuantifier(state, true) && state.raise("Nothing to repeat"), state.eat(
          123
          /* { */
        ...
        var start = state.pos;
        if (state.lastAssertionIsQuantifiable = false, state.eat(
          94
          /* ^ */
        ) || state.eat(
          36
        ...
        if (state.eat(
          ...
          if (this.options.ecmaVersion >= 9 && (lookbehind = state.eat(
            ...
            return this.regexp_disjunction(state), state.eat(
              41
              /* ) */
            ) || state.raise("Unterminated group"), state.lastAssertionIsQuantifiable = !lookbehind, true;
        }
        return state.pos = start, false;
      }, pp$8.regexp_eatQuantifier = function(state, noError) {
        return noError === void 0 && (noError = false), this.regexp_eatQuantifierPrefix(state, noError) ? (state.eat(
          63
          /* ? */
        ), true) : false;
            ...
            if (switchU && lead >= 55296 && lead <= 56319) {
              ...
              if (state.eat(
                ...
                if (trail >= 56320 && trail <= 57343)
                  return state.lastIntValue = (lead - 55296) * 1024 + (trail - 56320) + 65536, true;
              }
      ...
      pp$8.regexp_eatIdentityEscape = function(state) {
        if (state.switchU)
          return this.regexp_eatSyntaxCharacter(state) ? true : state.eat(
            47
            /* / */
          ) ? (state.lastIntValue = 47, true) : false;
        var ch = state.current();
...
var import_escodegen = __toESM2(require_escodegen(), 1);
...
var import_acorn = __toESM2(require_acorn(), 1);
var import_acorn_jsx = __toESM2(require_acorn_jsx(), 1);
...
var import_html_tags = __toESM2(require_html_tags2(), 1);
...
var objectResolver = (rawDefaultProp) => {
  ...
  if (isPlainObject2(rawDefaultProp)) {
...
// node_modules/@storybook/react/dist/_browser-chunks/chunk-OCTWNRZO.js
...
var reactElementToJSXString2 = reactElementToJsxString;
...
var renderJsx = (code, options) => {
  ...
  for (let i = 0; i < options?.skip; i += 1) {
    ...
    if (import_react5.default.Children.count(renderedJSX) > 1)
      return logger.warn("Trying to skip an array of elements"), null;
    typeof renderedJSX.props.children > "u" ? (logger.warn("Not enough children to skip elements."), typeof renderedJSX.type == "function" && renderedJSX.type.name === "" && (renderedJSX = import_react5.default.createElement(Type, { ...renderedJSX.props }))) : typeof renderedJSX.props.children == "function" ? renderedJSX = renderedJSX.props.children() : renderedJSX = renderedJSX.props.children;
  }
  ...
  return import_react5.default.Children.map(code, (c) => {
    let child = typeof c == "number" ? c.toString() : c, string = (typeof reactElementToJSXString2 == "function" ? reactElementToJSXString2 : (
      // @ts-expect-error (Converted from ts-ignore)
      reactElementToJSXString2.default
...
var mdxToJsx = (node) => {
  ...
  return children && (jsxChildren = (Array.isArray(children) ? children : [children]).map(mdxToJsx)), (0, import_react5.createElement)(originalType, rest, ...jsxChildren);
};
...
var decorators2 = "FEATURES" in globalThis && globalThis?.FEATURES?.experimentalCodeExamples ? [] : [jsxDecorator];
var parameters3 = {
  docs: {
    story: { inline: true }
  }
...
// node_modules/@storybook/react/dist/_browser-chunks/chunk-M77NQZM3.js
function __definePreview(input) {
  let preview = definePreview({
    ...input,
    addons: [
...
function setProjectAnnotations2(projectAnnotations) {
  return setDefaultProjectAnnotations(INTERNAL_DEFAULT_PROJECT_ANNOTATIONS), setProjectAnnotations(
    projectAnnotations
  );
}
var INTERNAL_DEFAULT_PROJECT_ANNOTATIONS = composeConfigs([
  ...
  entry_preview_argtypes_exports,
  {
    ...
    renderToCanvas: async (renderContext, canvasElement) => {
      ...
      let {
        storyContext: { context, unboundStoryFn: Story, testingLibraryRender: render2 }
      } = renderContext, { unmount } = render2(React7.createElement(Story, { ...context }), { container: context.canvasElement });
      return unmount;
    }
  }
]);
...
//# sourceMappingURL=@storybook_react-vite.js.map
