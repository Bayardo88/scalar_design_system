...
import {
  versions_default
} from "./chunk-4MXQJO77.js";
import {
  require_picomatch
} from "./chunk-X7HAU6DT.js";
import {
  logger
} from "./chunk-SCU5NENN.js";
import {
  any,
  from,
  invariant,
...
import {
  ...
  resolvePackageDir,
  safeResolveModule
} from "./chunk-YAOMP7IG.js";
import {
  join,
  parse,
  resolve
} from "./chunk-NW62H5AE.js";
import {
  glob,
  globSync
} from "./chunk-FBCRFPN7.js";
import {
  slash
} from "./chunk-5UPUD6R2.js";
import {
  require_dist
} from "./chunk-W5LQJEKW.js";
import {
  require_picocolors
} from "./chunk-JBNSDLDN.js";
import {
  __commonJS,
  __esm,
  __export,
...
async function loadEnvs(options = {}) {
  let { getEnvironment } = await import("./lib-QW4KAC77.js"), defaultNodeEnv = options.production ? "production" : "development", env2 = {
...
async function scanAndTransformFiles({
  ...
  let globby = (await import("./globby-GXCQUKBS.js")).globby, sourceFiles = await globby([glob2], {
    ...commonGlobOptions(""),
    ignore: ["**/node_modules/**"],
    dot: !0,
    cwd: getProjectRoot(),
...
var transformImportFiles = async (files, renamedImports, dryRun) => {
  let errors = [], { default: pLimit } = await import("./p-limit-4ELWV6QF.js"), limit = pLimit(10);
  return await Promise.all(
    files.map(
      (file) => limit(async () => {
        try {
