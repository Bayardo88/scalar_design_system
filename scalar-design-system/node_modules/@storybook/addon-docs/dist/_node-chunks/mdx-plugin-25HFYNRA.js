...
import {
  compile
} from "./chunk-UHXRN2HF.js";
import "./chunk-UDYAFSKF.js";
import "./chunk-FV7EOU3I.js";
import {
  __commonJS,
  __toESM
} from "./chunk-HRLOHX4R.js";
...
async function mdxPlugin(options) {
  let filter = createFilter(/\.mdx$/), { presets } = options, mdxPluginOptions = (await presets.apply("options", {}))?.mdxPluginOptions, rehypeSlug = (await import("./rehype-slug-EBWWWHXI.js")).default, rehypeExternalLinks = (await import("./rehype-external-links-4M3FZ7NI.js")).default;
  return {
