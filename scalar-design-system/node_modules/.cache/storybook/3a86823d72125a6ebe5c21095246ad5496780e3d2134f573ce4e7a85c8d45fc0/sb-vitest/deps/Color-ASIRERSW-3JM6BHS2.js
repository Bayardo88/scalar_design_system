...
import "./chunk-EKBGNYCJ.js";
import "./chunk-MDY4W6MM.js";
import "./chunk-ZD4VCADI.js";
import {
  styled
} from "./chunk-OVAVTTB6.js";
import "./chunk-DSDQHJ7V.js";
import "./chunk-QTHO6G2T.js";
import "./chunk-XOGORFPY.js";
import "./chunk-QLUIIR5G.js";
import "./chunk-KH47UKKM.js";
import "./chunk-6DO6LUFC.js";
...
// node_modules/@storybook/addon-docs/dist/_browser-chunks/Color-ASIRERSW.js
...
var S = import_react2.default.memo(function(r2) {
  ...
  return import_react2.default.createElement("div", { className: o2 }, import_react2.default.createElement(m, { onMove: function(e2) {
    n2({ h: 360 * e2.left });
  }, onKey: function(e2) {
    n2({ h: s(t2 + 360 * e2.left, 0, 360) });
  }, "aria-label": "Hue", "aria-valuenow": b(t2), "aria-valuemax": "360", "aria-valuemin": "0" }, import_react2.default.createElement(p, { className: "react-colorful__hue-pointer", left: t2 / 360, color: q({ h: t2, s: 100, v: 100, a: 1 }) })));
});
var T = import_react2.default.memo(function(r2) {
  var t2 = r2.hsva, n2 = r2.onChange, o2 = { backgroundColor: q({ h: t2.h, s: 100, v: 100, a: 1 }) };
  return import_react2.default.createElement("div", { className: "react-colorful__saturation", style: o2 }, import_react2.default.createElement(m, { onMove: function(e2) {
    n2({ s: 100 * e2.left, v: 100 - 100 * e2.top });
  }, onKey: function(e2) {
    n2({ s: s(t2.s + 100 * e2.left, 0, 100), v: s(t2.v - 100 * e2.top, 0, 100) });
  }, "aria-label": "Color", "aria-valuetext": "Saturation " + b(t2.s) + "%, Brightness " + b(t2.v) + "%" }, import_react2.default.createElement(p, { className: "react-colorful__saturation-pointer", top: 1 - t2.v / 100, left: t2.s / 100, color: q(t2) })));
});
...
var R;
var V = typeof window < "u" ? import_react2.useLayoutEffect : import_react2.useEffect;
var $ = function() {
...
var U = function(t2) {
  var n2 = t2.className, o2 = t2.colorModel, a2 = t2.color, l2 = a2 === void 0 ? o2.defaultColor : a2, i2 = t2.onChange, s2 = c(t2, ["className", "colorModel", "color", "onChange"]), f2 = (0, import_react2.useRef)(null);
  Q(f2);
...
var ee = function(r2) {
  ...
  return import_react2.default.createElement("div", { className: l2 }, import_react2.default.createElement("div", { className: "react-colorful__alpha-gradient", style: a2 }), import_react2.default.createElement(m, { onMove: function(e2) {
    o2({ a: e2.left });
  }, onKey: function(e2) {
    o2({ a: s(n2.a + e2.left) });
  }, "aria-label": "Alpha", "aria-valuetext": u2 + "%", "aria-valuenow": u2, "aria-valuemin": "0", "aria-valuemax": "100" }, import_react2.default.createElement(p, { className: "react-colorful__alpha-pointer", left: n2.a, color: k(n2) })));
};
var re = function(t2) {
  var n2 = t2.className, o2 = t2.colorModel, a2 = t2.color, l2 = a2 === void 0 ? o2.defaultColor : a2, i2 = t2.onChange, s2 = c(t2, ["className", "colorModel", "color", "onChange"]), f2 = (0, import_react2.useRef)(null);
  Q(f2);
...
var swatchBackground = (isDark) => `url('data:image/svg+xml;charset=utf-8,<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill-opacity="0.05" fill="${isDark ? "white" : "black"}"><path d="M8 0h8v8H8zM0 8h8v8H0z"/></svg>')`;
...
var useColorInput = (initialValue, onChange) => {
  let [value, setValue] = (0, import_react.useState)(initialValue || ""), [color, setColor] = (0, import_react.useState)(() => parseValue(value)), [colorSpace, setColorSpace] = (0, import_react.useState)(
  ...
  let realValue = (0, import_react.useMemo)(
    () => getRealValue(value, color, colorSpace).toLowerCase(),
    [value, color, colorSpace]
  ), updateValue = (0, import_react.useCallback)(
    (update) => {
...
var usePresets = (presetColors, currentColor, colorSpace) => {
  ...
  let presets = (0, import_react.useMemo)(() => (presetColors || []).map((preset) => typeof preset == "string" ? parseValue(preset) : preset.title ? { ...parseValue(preset.color), keyword: preset.title } : parseValue(preset.color)).concat(selectedColors).filter(Boolean).slice(-27), [presetColors, selectedColors]), addPreset = (0, import_react.useCallback)(
    (color) => {
...
var ColorControl = ({
  ...
  let debouncedOnChange = (0, import_react.useCallback)(debounce(onChange, 200), [onChange]), { value, realValue, updateValue, color, colorSpace, cycleColorSpace } = useColorInput(
    initialValue,
    debouncedOnChange
  ...
  return import_react.default.createElement(Wrapper, null, import_react.default.createElement("label", { htmlFor: controlId, className: "sb-sr-only" }, name), import_react.default.createElement(
    Input,
    {
      id: controlId,
      value,
    ...
    PopoverProvider,
    {
      ...
      popover: import_react.default.createElement(TooltipContent, null, import_react.default.createElement(
        Picker,
        {
  ...
  ), value ? import_react.default.createElement(
    ...
    import_react.default.createElement(MarkupIcon, null)
  ) : null);
};
...
//# sourceMappingURL=Color-ASIRERSW-3JM6BHS2.js.map
